...
public:
	...
	/// height-based activations - // Actual figures noted after chain was fixed and moving.
        ...
        consensus.height_start_StateRoots = 3267615;
...
public:
    CTestNetParams()
    {
        ...
        consensus.height_last_PoW = 20000000;
        ...
        consensus.height_start_StateRoots = 5000; // <<<--- ADD THIS (Use an appropriate low height for testnet!)
